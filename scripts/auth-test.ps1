...
Write-Host "`n🎫 Minting ID token with impersonation..." -ForegroundColor Yellow
try {
...
foreach ($endpoint in $endpoints) {
    ...
    Write-Host "`nTesting: $($endpoint.Description)" -ForegroundColor Cyan
...
# Test envelope endpoint (POST)
Write-Host "`n🧪 Testing envelope endpoint (POST)..." -ForegroundColor Yellow
